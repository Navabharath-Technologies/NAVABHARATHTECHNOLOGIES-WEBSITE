...
const translations = {
    en: {
        ...
        service1_description: "Custom websites built with modern technologies to ensure performance and scalability. We specialize in creating responsive, secure, and SEO-optimized web applications tailored to your specific business requirements. From corporate portals to complex e-commerce platforms, our full-stack solutions drive engagement and growth.",
        service2_title: "Mobile App Development",
        service2_description: "Native and cross-platform mobile applications designed for seamless user experiences. We build high-performance iOS and Android apps using modern frameworks. Our mobile solutions focus on intuitive UI design, robust backend integration, and rigorous testing to ensure your app dominates the app store charts and delights your users.",
        ...
        service6_description: "Advanced Interactive Voice Response systems to automate customer interactions and streamline call management. Our intelligent IVR solutions reduce wait times, intelligently route calls to the right departments, and provide 24/7 self-service options. Enhance your customer support capabilities while significantly lowering operational costs and improving caller satisfaction.",
