...
const translations = {
    ...
    fr: {
        ...
        service5_description: "Mise en œuvre de stratégies marketing intelligentes pour booster votre présence en ligne.",
    ...
    ar: {
        ...
        service5_description: "تنفيذ استراتيجيات تسويق ذكية لتعزيز تواجدك عبر الإنترنت.",
        service6_title: "حلول الاستجابة الصوتية التفاعلية (IVR)",
        service6_description: "أنظمة متقدمة للاستجابة الصوتية التفاعلية لأتمتة تفاعلات العملاء وتبسيط إدارة المكالمات بقوائم صوتية ذكية.",
        service7_title: "حلول الذكاء الاصطناعي",
        service7_description: "حلول الذكاء الاصطناعي والتعلم الآلي المتطورة لأتمتة العمليات وتحسين اتخاذ القرارات وفتح رؤى قائمة على البيانات لعملك.",

        // Why Choose Us Section
        why_choose_title: "لماذا تختار Navabharath Technologies؟",
        ...
        explore_intro_title: "Navabharath Technologies — دفع النمو من خلال حلول تكنولوجيا المعلومات الذكية",
        explore_intro_desc: "Navabharath Technologies هي شركة حلول تكنولوجيا معلومات ذات تفكير مستقبلي تقدم خدمات رقمية ذكية وقابلة للتطوير وموجهة نحو النتائج. مع تركيز قوي على الابتكار والتصميم الذي يركز على العملاء، نساعد الشركات على التحول والأتمتة والنمو في العالم الرقمي سريع التطور اليوم. بدعم من فريق من ذوي الخبرة والتقنيات الحديثة، نضمن التنفيذ السلس وسير العمل المطور وتسليم عالي الجودة. تفانينا في التميز والشفافية والموثوقية يجعلنا شريكًا موثوقًا للشركات من جميع الأحجام.",
        explore_what_do_title: "ماذا نفعل",
        explore_what_do_1: "بناء مواقع ويب وتطبيقات ومنتجات رقمية مخصصة مصممة للأداء طويل المدى.",
        explore_what_do_2: "استراتيجيات وتقنيات ذكية تتناسب مع أهدافك وسير عملك.",
        explore_what_do_3: "أنظمة رقمية قوية وموثوقة ومحسنة لتحقيق أقصى قدر من الكفاءة.",
        explore_what_do_4: "حلول مصممة مع مراعاة سهولة الاستخدام والخبرة وتأثير الأعمال.",
        explore_mission_title: "مهمتنا",
        explore_mission_p1: "مهمتنا هي تمكين الشركات بحلول رقمية متقدمة تسرع النمو وتعزز ميزتها التنافسية. نركز على تحسين الكفاءة التشغيلية من خلال تقنيات ذكية وآلية وقابلة للتطوير تعمل على تبسيط كل سير عمل. من خلال تقديم تجارب رقمية عالية الجودة، نضمن النجاح طويل المدى والتنمية المستدامة لعملائنا. نبتكر باستمرار ونتكيف مع احتياجات الصناعة المتطورة لتقديم حلول حديثة وجاهزة للمستقبل. من خلال التزامنا بالتميز، نسعى جاهدين لخلق قيمة ذات معنى ومساعدة الشركات على العمل بذكاء وسرعة وكفاءة أكبر.",
        explore_vision_title: "رؤيتنا",
        explore_vision_p1: "رؤيتنا هي أن نكون رائدًا عالميًا في التحول الرقمي، معترفًا بقدرتنا على تحويل التحديات المعقدة إلى حلول تكنولوجية بسيطة وفعالة. نطمح لبناء مستقبل حيث تتمتع كل شركة، بغض النظر عن حجمها، بالوصول إلى الأدوات التي تحتاجها لتزدهر في اقتصاد رقمي أولاً. من خلال تعزيز ثقافة الإبداع والنزاهة والتعاون، نهدف إلى وضع معايير جديدة في صناعة تكنولوجيا المعلومات. نرى أنفسنا كمحفزين للتغيير، ودفع التقدم والابتكار الذي لا يفيد عملاءنا فحسب، بل يساهم أيضًا في عالم أكثر اتصالاً وكفاءة.",
        explore_values_title: "ماذا نفعل",
        explore_what_we_do_p1: "نحن متخصصون في مجموعة واسعة من خدمات تكنولوجيا المعلومات المصممة لتلبية الاحتياجات المتنوعة للشركات الحديثة. من تطوير البرامج المخصصة وإنشاء تطبيقات الأجهزة المحمولة إلى الحوسبة السحابية وتحليلات البيانات، نقدم حلولًا شاملة تحقق النتائج. يعمل فريق خبرائنا بشكل وثيق مع العملاء لفهم تحدياتهم وأهدافهم الفريدة، وتقديم استراتيجيات مخصصة تزيد من عائد الاستثمار. سواء كنت بحاجة إلى تحديث الأنظمة القديمة، أو بناء منتج رقمي جديد من الصفر، أو تحسين بنيتك التحتية الحالية، فلدينا الخبرة والتجربة لمساعدتك على النجاح.",
        explore_trust_title: "لماذا تثق الشركات بنا",
        explore_trust_1_title: "1. نهج قائم على الابتكار",
        explore_trust_1_desc: "نستخدم أدوات حديثة وأفضل الممارسات لتقديم حلول جاهزة للمستقبل.",
        explore_trust_2_title: "2. تنفيذ يركز على العميل",
        explore_trust_2_desc: "يتم تخصيص كل مشروع لأهداف عملك وسير عملك.",
        explore_trust_3_title: "3. محترفون مهرة",
        explore_trust_3_desc: "فريق يجمع بين الإبداع والخبرة ومعرفة الصناعة.",
...
// ========================================
// HAPPY NEW YEAR POPUP WITH CRACKERS & FIREWORKS
// ========================================
...
window.addEventListener('load', () => {
    ...
    setTimeout(showNewYearPopup, 1000);
});
